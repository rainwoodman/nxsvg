...
g = nx.DiGraph()
g.add_node('Vous', position=(-1, 3), fill='blue')
g.add_node('Tu', position=(1, 3), fill='white')
g.add_node('I am confused', position=(0, 3), fill='red')
g.add_node('Are you an adult?', position=(0., 0.), rx=0, ry=0, stroke_width='3px', fill='gray')
